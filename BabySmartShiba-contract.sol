...
//Disrupting the crypto space with a revolutionary, progressive and amazing ///TRIPLE BURN ™\\\ SHIBA INU and SmartShiba Live  program
//KYC and Audited Contract
//SMARTSHIBA INU rewards 3% 
//SMARTSHIBA BURN 2%
//SHIBA INU BURN 2%
//BBsmartshiba burn 2%  
//Marketing Wallet 3%  
//Liquidity 1%
//TOTAL BUY/SELL fees  13%
//https://t.me/SmartShibaLiveBurns
//http://bbsmartshiba.army/
//https://twitter.com/smartshiba1
//ARE YOU READY?
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0xd5ADd5009c90044Fb9C65B2D5Fe17aBA6d4495Aa);
...
contract BBSMARTSHIBA is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0xd5ADd5009c90044Fb9C65B2D5Fe17aBA6d4495Aa;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BBSMARTSHIBA ";
    string constant _symbol = "BBSHI";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 200; //  500 000 tokens per tx 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xe6882B32106226E99ce4C22a2B4A71c6b5356f1D;
